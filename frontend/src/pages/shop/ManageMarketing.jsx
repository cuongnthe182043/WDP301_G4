...
const ITEMS = [
  ...
  { icon: Megaphone, label: "Chiến dịch",   desc: "Gửi thông báo & voucher đến khách hàng",   to: "/shop/marketing/campaigns" },
  { icon: Gift,      label: "Tín dụng",     desc: "Tặng và quản lý tín dụng cửa hàng",         to: "/shop/marketing/credits" },
];
